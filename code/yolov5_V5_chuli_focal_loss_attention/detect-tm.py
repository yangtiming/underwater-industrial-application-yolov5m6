...
def run(weights='yolov5s.pt',  # model.pt path(s)
    ...
    classes_underwater = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light',
...
def parse_opt():
    ...
    parser.add_argument('--result_name', default='./result.csv', help='save results')
